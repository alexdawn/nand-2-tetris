...
class CodeWriter:
    ...
    def write_push_pop(self, command: InstructionType, segment: str, index: int, debug_text: str) -> None:
    ...
    def write_comment(self, command: str, segment: str, index: int, debug_text: str) -> None:
    ...
    def put_constant(self, index: str) -> None:
        """Used for both constant and temp segments RAM[i]=D, 
            gives a way for the VM to directly write to specific hardware memory"""
        self._write_to_file(f'''
            @{index}
            M=D
        ''')
    ...
    def write_function(self, name: str, number_variables: int, debug_text: str) -> None:
    ...
    def write_call(self, name: str, number_arguments: int, debug_text: str) -> None:
        """
