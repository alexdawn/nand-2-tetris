...
@SP
M=M+1
// Class1.vm:13    return from Class1.set
...
A=M-1
M=M-D
// Class1.vm:20    return from Class1.get
@LCL  // frame (stored in R15) = LCL
D=M
@R15
M=D
...
@SP
M=M+1
// Class2.vm:13    return from Class2.set
@LCL  // frame (stored in R15) = LCL
D=M
@R15
M=D
...
A=M-1
M=M-D
// Class2.vm:20    return from Class2.get
@LCL  // frame (stored in R15) = LCL
D=M
@R15
M=D
